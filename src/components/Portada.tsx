...
export const Portada: React.FC<PortadaProps> = ({
  ...
  return (
    <div className="space-y-16 pb-24">
      {/* Hero Banner Section */}
      <section className="relative overflow-hidden pt-12 pb-20 px-4 sm:px-6 lg:px-8 border-b border-slate-700/60">
        <div className="max-w-6xl mx-auto text-center space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-slate-800 border border-amber-400/40 text-amber-300 text-xs sm:text-sm font-semibold shadow-lg">
          ...
          <p className="max-w-3xl mx-auto text-slate-200 text-base sm:text-xl font-normal leading-relaxed">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-amber-400 hover:bg-amber-500 text-[#212121] font-black text-base shadow-xl shadow-amber-400/20 transition-all duration-200 flex items-center justify-center gap-3 group"
            >
              <Icon icon="lucide:users" className="w-5 h-5 group-hover:scale-110 transition-transform text-[#212121]" />
              <span>Explorar Salmistas y Volúmenes</span>
              <Icon icon="lucide:arrow-right" className="w-4 h-4 text-[#212121] group-hover:translate-x-1 transition-transform" />
            </button>

            <button
              onClick={() => onNavigateToTab('catalogo')}
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-slate-800 hover:bg-slate-700 border border-slate-600 text-white hover:text-white font-semibold text-base transition-all duration-200 flex items-center justify-center gap-3 shadow-lg"
            >
              <Icon icon="lucide:music-2" className="w-5 h-5 text-amber-400" />
          ...
          <div className="pt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="bg-slate-800 border border-slate-700 p-5 rounded-2xl text-center transform hover:scale-[1.02] transition-transform shadow-lg">
              ...
              <div className="text-xs text-slate-300 font-medium mt-1">Salmistas y Autores</div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 p-5 rounded-2xl text-center transform hover:scale-[1.02] transition-transform shadow-lg">
              ...
              <div className="text-xs text-slate-300 font-medium mt-1">Volúmenes / Álbumes</div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 p-5 rounded-2xl text-center transform hover:scale-[1.02] transition-transform shadow-lg">
              ...
              <div className="text-xs text-slate-300 font-medium mt-1">Alabanzas con Acordes</div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 p-5 rounded-2xl text-center transform hover:scale-[1.02] transition-transform shadow-lg">
              ...
              <div className="text-xs text-slate-300 font-medium mt-1">Transposición Rápida</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <button
            onClick={() => onNavigateToTab('autores')}
            className="self-start sm:self-auto text-sm font-semibold text-amber-400 hover:text-amber-300 flex items-center gap-1.5 transition-colors group"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {authors.map((author) => (
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-slate-700 flex items-center justify-between text-xs font-semibold text-slate-300 group-hover:text-white">
                <span className="flex items-center gap-1.5">
                  <Icon icon="lucide:disc" className="w-4 h-4 text-amber-400" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {featuredSongs.map(({ song, authorName, albumTitle, avatarBg }) => (
            <div
              ...
              className="group bg-slate-800 hover:bg-slate-750 border border-slate-700 hover:border-amber-400/50 rounded-2xl p-5 cursor-pointer transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-black/30 flex items-center justify-between gap-4 shadow-lg"
            >
              <div className="flex items-center gap-4 min-w-0">
                <div className={`w-12 h-12 rounded-xl ${avatarBg} p-0.5 shrink-0 flex items-center justify-center text-white font-bold text-lg shadow-md`}>
                  <div className="w-full h-full bg-slate-900 rounded-[10px] flex items-center justify-center group-hover:bg-transparent transition-colors">
                    <Icon icon="mdi:piano" className="w-6 h-6 text-amber-400 group-hover:text-[#212121]" />
                  </div>
                </div>

                <div className="min-w-0 flex-1">
                  <h4 className="font-bold text-white text-base break-words leading-snug group-hover:text-amber-300 transition-colors">
                    {song.title}
                  </h4>
                  <p className="text-xs text-slate-300 font-medium break-words mt-0.5">
                    {authorName} • <span className="text-slate-400">{albumTitle}</span>
                  </p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-slate-900 border border-slate-700 text-amber-300">
                      Tono: {song.originalKey}
                    </span>
                    <span className="text-[10px] font-medium px-2 py-0.5 rounded bg-slate-900 text-slate-300">
                      {song.difficulty}
                    </span>
                    <span className="text-[10px] font-medium px-2 py-0.5 rounded bg-slate-900 text-slate-300">
                      {song.timeSignature}
              ...
              <div className="w-9 h-9 rounded-full bg-slate-900 group-hover:bg-amber-400 border border-slate-700 group-hover:border-amber-400 flex items-center justify-center text-slate-400 group-hover:text-[#212121] shrink-0 transition-all">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl overflow-hidden border border-slate-700 bg-slate-800 p-8 sm:p-12 text-center shadow-2xl">
          <Icon icon="lucide:quote" className="w-12 h-12 text-amber-400/40 mx-auto mb-4" />
          <blockquote className="text-xl sm:text-2xl font-serif italic text-slate-100 max-w-3xl mx-auto leading-relaxed">
          ...
          <p className="mt-4 text-sm font-bold tracking-widest uppercase text-amber-400">
            Salmos 33:2-3
          </p>
        </div>
      </section>
