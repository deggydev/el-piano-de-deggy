  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all duration-200 flex items-center justify-between gap-4 group ${
                    isSelected
                      ...
                      : 'bg-slate-900/80 hover:bg-slate-900 border-slate-800/80 hover:border-slate-700 text-slate-300'
                  }`}
                >
        ...
        <div className="lg:col-span-8 space-y-8 bg-slate-900/50 border border-slate-800/80 rounded-3xl p-6 sm:p-8 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-6 border-b border-slate-800/80">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-purple-400 font-semibold text-sm sm:text-base mt-0.5">
            ...
            <div className="flex flex-wrap gap-3">
              {selectedAuthor.albums.map((album) => {
                ...
                return (
                  ...
                  >
                    <Icon icon="lucide:disc" className="w-4 h-4 text-purple-300" />
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-lg sm:text-xl font-extrabold text-white flex items-center gap-2">
                    <Icon icon="lucide:list-music" className="w-5 h-5 text-purple-400" />
              ...
              <div className="grid grid-cols-1 gap-3">
                {selectedAlbum.songs.map((song, idx) => (
                  <div
                    ...
                    className="group bg-slate-900/90 hover:bg-slate-800/90 border border-slate-800/80 hover:border-purple-500/50 rounded-2xl p-4 sm:p-5 cursor-pointer transition-all duration-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm hover:shadow-lg"
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      <div className="w-10 h-10 rounded-xl bg-purple-950 border border-purple-800/60 flex items-center justify-center font-black text-purple-300 text-sm shrink-0">
                        {idx + 1}
                      </div>
                      <div className="min-w-0">
                        <h5 className="font-bold text-white text-base sm:text-lg group-hover:text-purple-300 transition-colors truncate">
                          {song.title}
                        </h5>
                    ...
                    <div className="flex items-center justify-between w-full sm:w-auto gap-4 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-800/80 sm:border-none">
                      ...
                      <div className="px-4 py-2 rounded-xl bg-purple-600/10 group-hover:bg-purple-600 text-purple-300 group-hover:text-white font-bold text-xs sm:text-sm flex items-center gap-1.5 transition-all">
